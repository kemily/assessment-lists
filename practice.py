...
def long_words(words):
    ...
    If no words are longer than 4 characters, return an empty list::
        ...
        []
    """
    #I used list comprehension here
...
def n_long_words(words, n):
    ...
    For example::
        ...
        ['apples', 'bananas']
    """
    #I used list comprehension here as well
...
def halvesies(numbers):
    ...
    the half::
        ...
        [0.5, 2.5]
    """
    halfs = [float(number)/2 for number in numbers]
    return halfs
...
def reverse_list(items):
    ...
    **Do not use** the python function `reversed()` or the method
    ...
    You should do this without changing the original list::
        ...
        ['apple', 'berry', 'cherry']
    """
    #negative step  in list slicing returns a list backwards
    return items[::-1]
...
def duplicates(items):
    ...
    duplicate = []
    for item in items:
        if items.count(item) > 1 and item not in duplicate:
